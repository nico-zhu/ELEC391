 ...
 *             controlFrequency - The frequency at which the controler is running.
 */
void PIDInit(double *PIDstructure, double kp, double ki, double kd, double setpoint, double controlFrequency){
 ...
 */
double PIDcalculate(double *PIDstructure, double processVariable){
    //Set Error
